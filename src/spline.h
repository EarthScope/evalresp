...
void spline_overhauser_val ( int ndim, int ndata, double tdata[], double ydata[],
  double tval, double yval[], evalresp_log_t *log );
void spline_pchip_set ( int n, double x[], double f[], double d[], evalresp_log_t * );
void spline_pchip_val ( int n, double x[], double f[], double d[], int ne,
  double xe[], double fe[], evalresp_log_t *);
void spline_quadratic_val ( int ndata, double tdata[], double ydata[],
  double tval, double *yval, double *ypval, evalresp_log_t *);
void timestamp ( void );
