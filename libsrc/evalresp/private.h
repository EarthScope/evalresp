...
/**
 * @defgroup evalresp_public_channel evalresp Public Channel Interface
...
/**
 * @defgroup evalresp_public_response evalresp Public Response Interface
 * @ingroup evalresp_public
 ...
 *
 * This is done via two structures:
 ...
 *
 * In both cases, the user should create an instance, set appropriate values, and
