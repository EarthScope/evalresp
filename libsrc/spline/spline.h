...
void spline_overhauser_val ( int ndim, int ndata, double tdata[], double ydata[],
  double tval, double yval[], evalresp_logger *log );
void spline_pchip_set ( int n, double x[], double f[], double d[], evalresp_logger * );
void spline_pchip_val ( int n, double x[], double f[], double d[], int ne,
  double xe[], double fe[], evalresp_logger *);
void spline_quadratic_val ( int ndata, double tdata[], double ydata[],
  double tval, double *yval, double *ypval, evalresp_logger *);
void timestamp ( void );
#endif /* __EVALRESP_SPLINE_H__*/
